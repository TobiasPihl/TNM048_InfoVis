...
function area(data) {
    ...
    var area = d3.svg.area()
            .interpolate("step")
            .x(function (d) { return x(format.parse(d.time)); })	//Complete the code
            .y0(height)
            .y1(function (d) { return y(d.mag); }); //Complete the code
			
    //Creates the small chart        
        var area2 = d3.svg.area()
            .interpolate("step")
            .x(function (d) { return x2(format.parse(d.time)); })	//Complete the code
            .y0(height2)
            .y1(function (d) { return y2(d.mag); }); 	//Complete the code
    ...
    y.domain(d3.extent(data.map(function(d) { return d.mag; } )));				 //Complete the code
